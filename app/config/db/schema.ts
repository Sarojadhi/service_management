...
export const hospitals = pgTable("hospitals", {
	id: integer().primaryKey().generatedAlwaysAsIdentity({ name: "hospitals_id_seq", startWith: 1, increment: 1, maxValue: 2147483647, cache: 1 }),
	tenantId: integer().notNull(),
	name: varchar({ length: 255 }).notNull(),
...
export type NewWorkOrderTool = typeof workOrderTools.$inferInsert;
